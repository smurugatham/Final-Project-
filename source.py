...
Original file is located at
    https://colab.research.google.com/drive/1-PqkaTSF9A9y2hoAhQtDzuqO5WhW4-1g
...
### 2019 Daily mean concentration 10
"""
...
"""### 2020 Daily mean concentration 10"""
...
"""From the above two time series graphs (Fig 1 (left) and Fig 2(right)), we observe that the average daily CO concentration has been decreased in the year 2020 for both the PM2.5 and PM10 concentration as compared to the year 2019 from March to July. 
The main reason for this might be a lockdown due to pandemic as less vehicles on roads. Since most people are forced to stay at homes, lots of actvities which typically emit pollution like vehicle use, industrial production and waste deposition in large quantities are reduced. **bold text**
"""
...
"""
**Both the pollutants PM2.5 and PM10 are prevalent in urban and rural areas. But is there a difference in concentration between them? As one would expect, due to higehr density of vehicles in urban areas, more pollution is expected in those areas. But is that actually true?

In this analysis, the five boroughs are marked as urban areas while the other counties in New York are marked as rural** """
...
"""**From above analysis, we can say that for both the years 2019 and 2020 the pollution level for PM10 in urban areas are more as compared to that of the rural areas. As we can observe that the mean AQI value for year 2019 for urban and rural areas are 11.94 and 10.27 respectively and for year 2020 are 11.56 ad 9.91 respectively.**
...
"""**Street station has most number of pollutant as compared to other stations for PM 10 in both 2019 and 2020.** """
